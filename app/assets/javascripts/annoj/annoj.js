...
AnnoJ.Navigator = function() {
	...
	var Toolbar = new Ext.Toolbar({
		...
		items: ['Baseline', Controls.Baseline, ' ', Controls.showMode,'-', Controls.scaleMode, 'Multi', Controls.scaleBox, 'Y-axis', Controls.GlobalscaleBox,'-', Controls.dragMode, ' ', Controls.ratio, Controls.further, Controls.closer, ' ', Controls.assembly, Controls.jump, Controls.go, Controls.prev, Controls.next, '->', ' ']
...
var ModelsCanvas = function(userConfig) {
	...
	this.paint = function() {
		...
		/*									//removed by H. C.
		if(lane.indexOf("AJ_above") != -1 && sequence && ratio<=0.2 && (!data || data.length == 0)){
...
var ReadsCanvas = function(userConfig) {
	...
	this.paint = function() {
		...
		//else level += copies - 1;							//rmved by H. C. 2013-09-25
...
AnnoJ.BrowserTrack = function(userConfig) {
	...
	this.close = function() {
		...
		self.hide()									//added by H. C. 2013-09-26
	};
	this.hide = function() {
